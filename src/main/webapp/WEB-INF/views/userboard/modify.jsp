...
<form:form action="modify" method="post" id="modifyForm" modelAttribute="userBoard">
	<div class="container">
		...
		<div class="form-group">
			...
			<form:input type="text" class="form-control" path="title" value="${userBoard.title}"/>
		...
		<div class="form-group">
			...
			<form:textarea class="form-control" path="content" rows="10" value='<c:out value="${userBoard.content}"/>'/>
...
$(function(){
	let bnoValue = "${userBoard.bno}"
	console.log("게시물 번호 "+bnoValue);
